    ...
    stages {
        ...
        stage('Deploy to EC2') {
            steps {
              ...
              bat """
                    ssh -i "C:\\Program Files\\Jenkins\\to-do-app.pem" -o StrictHostKeyChecking=no ubuntu@16.79.142.118 "cd /home/ubuntu/to-do-app && git pull origin main && docker-compose down && docker-compose up -d --build"
                """
            }
        }
    }
